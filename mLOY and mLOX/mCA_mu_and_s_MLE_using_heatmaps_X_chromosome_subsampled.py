...
'''''
Watson code for estimating fitness effect (s) and mutation rate (mu) for mLOX (and confidence intervals), using MLE heatmaps, assuming a single s and mu.
Compared to the code for estimating s and mu of individual mCAs, this code uses a subsample of the data to calculate s and mu (due to the sheer number of mLOX calls)
...
Usage:
Watson_code_mCA_mu_and_s_MLE_using_heatmaps_X_chromosome_subsampled.py  --mCA name of mCA
...
total_people = 261890 #total women
...
def log_logit_CFs(df): #log and logit cell fractions
    ...
    print('total mLOX mCAs = '+str(len(logitCFs)))
...
def Probtheory(l, params): #= predicted density (i.e. normalised by 2 x mu)
    ...
    age35_39_ratio = 1/220893
    age40_44_ratio = 26598/220893
    age45_49_ratio = 35211/220893
    age50_54_ratio = 41397/220893
    age55_59_ratio = 48605/220893
    age60_64_ratio = 63511/220893
    age65_69_ratio = 45433/220893
    age70_74_ratio = 1134/220893
...
def main():
    ...
    df = pd.read_csv('Data_files/X_Y_mCAs/mLOX_CELL_FRAC.txt', sep = '\t')
